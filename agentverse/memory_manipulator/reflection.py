        ...
        for text in texts:
            ...
            for memory in memory_bank:
                if memory.content not in self.memory2time:
                    self.memory2time[memory.content]["last_access_time"] = self.agent.current_time #dt.now()
                    self.memory2time[memory.content]["create_time"] = self.agent.current_time #dt.now()
